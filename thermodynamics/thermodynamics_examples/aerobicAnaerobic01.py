...
def _main_():
    ...
    data_fva_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_fva_anoxic.json';
    data_srd_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_srd_anoxic.json';
    ...
    data_fva_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_fva_oxic.json';
    data_srd_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_srd_oxic.json';
    ...
    data_dG0_transformed = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_dG_f01.json';
    dG_f_data = thermodynamics_dG_f_data(id2KEGGID_filename_I='thermodynamics_data\\id2KEGGID.csv');
    ...
    data_concentrations_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_geo01.json';
    ...
    data_concentrations_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_geo01.json';
    ...
    data_ta_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_ta.csv';
    data_dG0_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_dG0.json';
    data_dG_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_dG.json';
    data_tcc_anoxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_tcc.json';
    ...
    data_ta_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_ta.csv';
    data_dG0_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_dG0.json';
    data_dG_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_dG.json';
    data_tcc_oxic = 'thermodynamics_data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_tcc.json';
