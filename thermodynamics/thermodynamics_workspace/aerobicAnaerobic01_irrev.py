...
def _main_():
    ...
    data_dG_escher_anoxic = 'data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_dG_escher_irrev.json';
    data_displacement_escher_anoxic = 'data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_displacement_escher_irrev.json';
    data_concentrations_escher_anoxic = 'data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_anoxic_concentrations_escher_irrev.json';
    tcc_anoxic = thermodynamics_dG_r_data();
    tcc_anoxic.calculate_dG0_r_v2(cobra_model_anoxic, dG_f_data.measured_dG_f, dG_f_data.estimated_dG_f, other_data.temperature); # calculate the change in free energy of reaction without accounting for metabolite concentrations
    tcc_anoxic.calculate_dG_r_v2(cobra_model_anoxic,metabolomics_data_anoxic.measured_concentrations, metabolomics_data_anoxic.estimated_concentrations,
    ...
    tcc_anoxic.calculate_displacement(cobra_model_anoxic,metabolomics_data_anoxic.measured_concentrations, metabolomics_data_anoxic.estimated_concentrations); # calculate the displacements from equillibrium
    ...
    tcc_anoxic.export_dG_r_escher(data_dG_escher_anoxic); # save for later use
    tcc_anoxic.export_displacement_escher(data_displacement_escher_anoxic); # save for later use
    tcc_anoxic.export_concentrations_escher(data_concentrations_escher_anoxic,metabolomics_data_anoxic.measured_concentrations); # save for later use
    #tcc_anoxic.import_dG0_r_json(data_dG0_anoxic); 
    #tcc_anoxic.import_dG_r_json(data_dG_anoxic);
    #tcc_anoxic.import_tcc_json(data_ta_anoxic);
    ...
    data_dG_escher_oxic = 'data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_dG_escher_irrev.json';
    data_displacement_escher_oxic = 'data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_displacement_escher_irrev.json';
    data_concentrations_escher_oxic = 'data\\aerobicAnaerobic01_geo\\aerobicAnaerobic01_oxic_concentrations_escher_irrev.json';
    tcc_oxic = thermodynamics_dG_r_data();
    tcc_oxic.calculate_dG0_r_v2(cobra_model_oxic, dG_f_data.measured_dG_f, dG_f_data.estimated_dG_f, other_data.temperature); # calculate the change in free energy of reaction without accounting for metabolite concentrations
    tcc_oxic.calculate_dG_r_v2(cobra_model_oxic,metabolomics_data_oxic.measured_concentrations, metabolomics_data_oxic.estimated_concentrations,
                       other_data.pH, other_data.ionic_strength, other_data.temperature); # adjust the change in free energy of reaction for intracellular metabolite concentrations
    tcc_oxic.check_thermodynamicConsistency(cobra_model_oxic,simulated_data_oxic.fva_data,
                       ...
                       other_data.pH,other_data.ionic_strength,other_data.temperature); # check the thermodynamic consistency of the data
    tcc_oxic.calculate_displacement(cobra_model_oxic,metabolomics_data_oxic.measured_concentrations, metabolomics_data_oxic.estimated_concentrations); # calculate the displacements from equillibrium
    ...
    tcc_oxic.export_dG_r_escher(data_dG_escher_oxic); # save for later use
    tcc_oxic.export_displacement_escher(data_displacement_escher_oxic); # save for later use
    tcc_oxic.export_concentrations_escher(data_concentrations_escher_oxic,metabolomics_data_oxic.measured_concentrations); # save for later use
    ...
    #tfba.tfba_looplaw(cobra_model_anoxic); # constraints need some work
    tfba.tsampling(cobra_model_anoxic,tcc_anoxic.dG_r, tcc_anoxic.metabolomics_coverage, tcc_anoxic.dG_r_coverage, tcc_anoxic.thermodynamic_consistency_check, 0.5, 0.99,use_measured_dG_r=True);
    tfba.tsampling_conc_ln(cobra_model_anoxic, metabolomics_data_anoxic.measured_concentrations, metabolomics_data_anoxic.estimated_concentrations, tcc_anoxic.dG0_r,
                      other_data.temperature, tcc_anoxic.dG_r_coverage, 0.99, use_measured_concentrations=False,use_measured_dG0_r=True, solver='gurobi');
    #tfba.tfba(cobra_model_anoxic,tcc_anoxic.dG_r, tcc_anoxic.metabolomics_coverage, tcc_anoxic.dG_r_coverage, tcc_anoxic.thermodynamic_consistency_check, 0.5, 0.99,use_measured_dG_r=True);
    #tfba.tfba_conc_ln(cobra_model_anoxic, metabolomics_data_anoxic.measured_concentrations, metabolomics_data_anoxic.estimated_concentrations, tcc_anoxic.dG0_r,
    #                  other_data.temperature, tcc_anoxic.dG_r_coverage, 0.99, use_measured_concentrations=False,use_measured_dG0_r=True, solver='gurobi');
    #tfba.tfva(cobra_model_anoxic, tcc_anoxic.dG_r, tcc_anoxic.metabolomics_coverage, tcc_anoxic.dG_r_coverage, tcc_anoxic.thermodynamic_consistency_check, 0.5, 0.99, use_measured_dG_r=True, solver='gurobi');
    #tfba.tfva_dG_r(cobra_model_anoxic, tcc_anoxic.dG_r, tcc_anoxic.metabolomics_coverage, tcc_anoxic.dG_r_coverage, tcc_anoxic.thermodynamic_consistency_check, 0.5, 0.99, use_measured_dG_r=True, solver='gurobi');
