...
sampling.generate_samples(cobra_model=cobra_model,filename_points = "test_tsampling_points.json",filename_warmup = "test_tsampling_warmup.json",solver_id_I = "glpk",n_points_I = 36,n_steps_I = 5000,n_threads_I = 2);
