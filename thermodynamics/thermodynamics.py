...
cobra_model_wt01 = create_cobra_model_from_sbml_file('data\\WtEcoli01_geo\\140601_iDMisotopomer_WTEColi_113C80_U13C20_01_OxicWtGlc.xml');
## evolved wild-type specific changes
#cobra_model_evo04 = create_cobra_model_from_sbml_file('data\\WtEcoli01_geo\\140601_iDMisotopomer_WTEColi_113C80_U13C20_01_OxicWtGlc.xml');
...
#data_fva_wt01 = 'data\\WtEcoli01_geo\\WtEcoli01_fva_wt01.json'; # for now until we reduce the model after fluxomics measurements
#data_srd_wt01 = 'data\\WtEcoli01_geo\\WtEcoli01_srd_wt01.json'; # for now until we reduce the model after fluxomics measurements
##data_fva_evo04 = 'data\\WtEcoli01_geo\\WtEcoli01_fva_evo04.json'; # for now until we reduce the model after fluxomics measurements
##data_srd_evo04 = 'data\\WtEcoli01_geo\\WtEcoli01_srd_evo04.json'; # for now until we reduce the model after fluxomics measurements
...
#simulated_data_evo04.import_sra_data(data_srd_wt01); # for now until we reduce the model after fluxomics measurements
#simulated_data_evo04.import_fva_data(data_fva_wt01); # for now until we reduce the model after fluxomics measurements
...
#inconsistent_concentrations = ['s7p_c'];
#metabolomics_data_wt01.remove_measured_concentrations(inconsistent_concentrations);
...
#                  other_data.temperature, tcc_wt01.metabolomics_coverage, tcc_wt01.dG_r_coverage, tcc_wt01.thermodynamic_consistency_check, 0.5, 0.99, use_measured_concentrations=False,use_measured_dG0_r=True, solver='gurobi');
